...
export default function DashboardPage() {
  ...
  const quickActions = [
    ...
    { icon: '🔖', label: 'Bookmarks', sub: 'Saved questions', color: '#3b82f6', href: '/bookmarks' },
  ];
    ...
    <div style={{ minHeight: '100vh', background: '#f0f4ff', fontFamily: 'Inter, system-ui', paddingBottom: '90px' }}>
      <div style={{ background: 'linear-gradient(135deg, #4f46e5 0%, #7c3aed 50%, #6366f1 100%)', padding: '20px 16px 24px', color: 'white', position: 'relative', overflow: 'hidden' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
          <div>
            ...
            <div style={{ fontSize: '22px', fontWeight: '800', lineHeight: 1.2 }}>Ready to crack<br />today exam? 🎯</div>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px' }}>
          {[{ label: 'Quizzes Done', value: stats.quizzes, icon: '📝' }, { label: 'Accuracy', value: stats.accuracy + '%', icon: '🎯' }, { label: 'Your Rank', value: stats.rank, icon: '🏆' }].map((s, i) => (
      ...
      <div style={{ padding: '16px', maxWidth: '640px', margin: '0 auto' }}>
        <div style={{ marginBottom: '20px' }}>
          <div style={{ fontSize: '13px', fontWeight: '700', color: '#64748b', marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>⚡ Quick Actions</div>
        ...
        <div style={{ background: 'white', borderRadius: '20px', padding: '16px', marginBottom: '16px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            <div>
              <div style={{ fontSize: '15px', fontWeight: '800', color: '#1e293b' }}>🎯 Today Targets</div>
